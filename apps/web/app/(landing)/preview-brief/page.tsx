...
import { PreviewBriefContent } from "./PreviewBriefContent";
import { SquaresPattern } from "@/app/(landing)/home/SquaresPattern";
import { CardBasic } from "@/components/ui/card";

export const metadata: Metadata = {
  title: "Your Brief is Ready | Inbox Zero",
  alternates: { canonical: "/preview-brief" },
};

export const dynamic = "force-dynamic";

export default async function PreviewBriefPage() {
