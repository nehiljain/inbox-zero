...
async function main() {
  ...
  if (!userEmail) {
    ...
    console.log("Usage: tsx scripts/read-user-schedules.ts [environment] <user-email>");
    console.log("Examples:");
    console.log("  Local:    tsx scripts/read-user-schedules.ts local jain.nehil@gmail.com");
    console.log("  Prod:     tsx scripts/read-user-schedules.ts production rameel@thebottleneck.io");
    console.log("  Prod:     tsx scripts/read-user-schedules.ts prod rameel@thebottleneck.io");
    process.exit(1);
  }
