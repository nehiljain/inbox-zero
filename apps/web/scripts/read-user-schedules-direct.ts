...
async function main() {
  ...
  if (!userEmail) {
    ...
    console.log("Usage: tsx scripts/read-user-schedules-direct.ts <user-email>");
    console.log("Examples:");
    console.log("  tsx scripts/read-user-schedules-direct.ts jain.nehil@gmail.com");
    console.log("  tsx scripts/read-user-schedules-direct.ts rameel@thebottleneck.io");
    process.exit(1);
  }
